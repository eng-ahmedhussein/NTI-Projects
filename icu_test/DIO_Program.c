...
void DIO_voidTogglePin( u8 DIO_u8PortID,u8 DIO_u8PinID )
{

	switch (DIO_u8PortID)
		{
			case DIO_u8_PORTA :
			TOGGLE_BIT(DIO_u8_PORTA_REG,DIO_u8PinID) ;
			break ;
			case DIO_u8_PORTB:
			TOGGLE_BIT(DIO_u8_PORTB_REG,DIO_u8PinID) ;
			break ;
			case DIO_u8_PORTC :
			TOGGLE_BIT(DIO_u8_PORTC_REG,DIO_u8PinID) ;
			break ;
			case DIO_u8_PORTD:
			TOGGLE_BIT(DIO_u8_PORTD_REG,DIO_u8PinID) ;
			break ;
